...
type ValueURL = { id: string; value: any } & { id: string; desc: boolean }

type ValueParsers = (value: ValueURL | any) => any
type TransformBuild = (
  value: ValueURL | any,
  transformHelper: TransformHelper
) => any
type QueryBuilders = (value: ValueURL | any, queryHelper: QueryHelper) => any
